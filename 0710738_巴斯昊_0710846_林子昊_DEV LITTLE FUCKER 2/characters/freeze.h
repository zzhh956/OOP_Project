...
//-----------------------------------------------------------------------紀錄當前為哪一張圖片 
	...
	int manywind_right_count;//紀錄當前要秀哪一張額外捲風技能圖片
	int manywind_left_count;//紀錄當前要秀哪一張額外捲風技能圖片
	int number_of_wind;//紀錄有幾顆捲風 
//-----------------------------------------------------------------------紀錄位置、方向、觸發旗標 
	...
	int flag_wind_past;//記錄前一顆捲風的狀態，1為往左射，2為往右射 
	int flag_manywind_remain;//記錄前一顆捲風是否依然存在，0為不存在，1為存在
	int flag_wind_record_receive;//記錄捲風是否被接收，0為尚未，1為接收了
	...
	int wind_ori_position_x;//捲風技能一開始位置 
	int wind_ori_position_y;//捲風技能一開始位置
	...
	int manywind_position_x;//額外捲風技能目前位置 
	int manywind_position_y;//額外捲風技能目前位置
	int last_manywind_position_x;//額外捲風技能最終位置
//------------------------------------------------------------------------紀錄圖檔 
