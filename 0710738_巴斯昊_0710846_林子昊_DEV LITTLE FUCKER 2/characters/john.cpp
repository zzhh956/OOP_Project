...
void John::getdata(int &p1_position_x,int &p1_position_y,int &p1_skill1_position_x,int &p1_skill1_position_y,int &p1_skill2_position_x,
...
void John::setdata(int down_switch,int defense_switch){
	if(down_switch==1)
		flag_down=1;
	if(defense_switch==1){
		flag_defense=1;
