...
void getimg_menu1(int pic)
{
	setactivepage(0);
	imagec = getimage(back[pic], size[pic][0], size[pic][1], 1);
	imagelf = getimage(".\\image\\menu1\\1.jpg", 496, 80, 1);
	imageop_m1 = getimage(".\\image\\menu1\\2.jpg", 282, 79, 1);
	imageop_m2 = getimage(".\\image\\menu2\\1.jpg", 305, 73, 1);
	imagenopm1_1 = getimage(".\\image\\menu1\\3.jpg", 256, 26, 1);
	imagenopm1_2 = getimage(".\\image\\menu1\\4.jpg", 256, 29, 1);
}

void getimg_menu2(int pic)
{
	setactivepage(0);
	imagec = getimage(back[pic], size[pic][0], size[pic][1], 1);
