...
Woody::Woody(){
	...
	wa_b_a=800;ha_b_a=80;pn_b_a=10;wn_b_a=10;hn_b_a=1;bkcolor_b_a=15;//投擲球技能圖檔切割數據
	wa_b=328;ha_b=249;pn_b=12;wn_b=4;hn_b=3;bkcolor_b=15;//投擲球技能圖檔切割數據
//--------------------------------------------------------------------------------------存圖檔名稱 
...
void Woody::print_ball(){
	if(flag_ball_action==1&&flag_ball_right==1){//技能被按且方向為右(動作部分)(角色只會做這投擲球動作，按其他按鍵會無反應)
		...
		if(ball_right_count>3)
			...
			ball_right_count=0;
		if(ball_position_x>position_x+400){
			ball_right_count=0;
			flag_ball_right=0;
		}
	}
