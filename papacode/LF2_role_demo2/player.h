...
public:
	Player(char*,char*,int,int,int,int,int,int,int,int,int,int,int,int//移動及普攻圖檔資料
		,char*,char*,int,int,int,int,int,int,int,int,int,int,int,int//投擲飛碟技能圖檔資料
		,char*,char*,int,int,int,int,int,int,int,int,int,int,int,int//飛碟技能圖檔資料
