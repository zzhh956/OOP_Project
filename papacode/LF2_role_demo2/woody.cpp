...
void Woody::Woody_set(int player)
{
	if(player==1){
		int up6_key=0x26;//上 
		int do6_key=0x28;//下 
...
char *receive_file_kick_right_action_picture,char *receive_file_kick_left_action_picture,int wa_D_R_A,int ha_D_R_A,int pn_D_R_A,
...
, int player
	...
	wa_d_r_a=wa_D_R_A;ha_d_r_a=ha_D_R_A;pn_d_r_a=pn_D_R_A;wn_d_r_a=wn_D_R_A;hn_d_r_a=hn_D_R_A;bkcolor_d_r_a=bkcolor_D_R_A;//往右踢擊技能圖檔切割數據
	wa_d_l_a=wa_D_L_A;ha_d_l_a=ha_D_L_A;pn_d_l_a=pn_D_L_A;wn_d_l_a=wn_D_L_A;hn_d_l_a=hn_D_L_A;bkcolor_d_l_a=bkcolor_D_L_A;//往左踢擊技能圖檔切割數據
...
//		
	strcpy(filename_kick_right_action,receive_file_kick_right_action_picture);
	filename_kick_right_action[strlen(receive_file_kick_right_action_picture)]='\0';

	strcpy(filename_kick_left_action,receive_file_kick_left_action_picture);
	filename_kick_left_action[strlen(receive_file_kick_left_action_picture)]='\0';	
//		
